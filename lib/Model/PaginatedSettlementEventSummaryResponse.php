...
/**
 * PaginatedSettlementEventSummaryResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaginatedSettlementEventSummaryResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaginatedSettlementEventSummaryResponse';
    ...
    protected static $swaggerTypes = [
        'count' => 'int',
'data' => '\Swagger\Client\Model\SettlementEventSummary[]',
'prev_page' => 'string',
'next_page' => 'string'    ];
...
'next_page' => 'getNextPage'    ];
     ...
     * Sets count
     *
     * @param int $count The number of settlement summary events returned on the current page.
     *
     * @return $this
     */
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\SettlementEventSummary[]
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\SettlementEventSummary[] $data data
     *
     * @return $this
     */
