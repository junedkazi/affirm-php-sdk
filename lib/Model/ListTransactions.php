...
/**
 * ListTransactions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListTransactions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListTransactions';
...
'has_next' => 'getHasNext'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['has_prev'] = isset($data['has_prev']) ? $data['has_prev'] : null;
     ...
     * Sets transactions
     *
     * @param \Swagger\Client\Model\Transaction[] $transactions An array of transactions.
     *
     * @return $this
     */
     ...
     * Sets has_prev
     *
     * @param bool $has_prev Boolean indicating whether previous (newer) results exist
     *
     * @return $this
     */
     ...
     * Sets has_next
     *
     * @param bool $has_next Boolean indicating whether next (older) results exist
     *
     * @return $this
     */
